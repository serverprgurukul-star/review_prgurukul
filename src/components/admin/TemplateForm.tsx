...
const moodsList = [
  ...
  { key: "sad", label: "Average", icon: Frown, color: "text-blue-700", bg: "bg-blue-100", border: "border-blue-300" },
  { key: "angry", label: "Disappointing", icon: AlertCircle, color: "text-red-700", bg: "bg-red-100", border: "border-red-300" },
